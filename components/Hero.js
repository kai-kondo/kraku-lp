  ...
  return (
    <div className="max-w-screen-xl mt-7 px-4 sm:px-8 xl:px-16 mx-auto">
      ...
      <ScrollAnimationWrapper>
        <motion.div
          className="grid grid-cols-1 md:grid-cols-2 gap-4 py-6 sm:py-10"
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="text-center">
              <h1 className="text-1xl sm:text-2xl md:text-3xl lg:text-3xl font-bold text-black-600 leading-snug">
                軽配送業の経営を
                <strong className="font-bold text-pink-100">ラクに</strong>{" "}
                <br />
              </h1>
          ...
          {/* 右側のフォーム */}
          <div className="flex flex-col justify-center mx-auto max-w-full sm:max-w-sm" id="Hero">
      ...
      <div className="relative w-full flex">
        <ScrollAnimationWrapper className="rounded-lg w-full grid grid-flow-row sm:grid-flow-row grid-cols-1 sm:grid-cols-3 py-6 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-100 bg-white500 z-10">
